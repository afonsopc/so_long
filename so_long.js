...
(() => {
  ...
  function loadPackage(metadata) {
    ...
    function runWithFS(Module) {
      ...
      function processPackageData(arrayBuffer) {
        ...
        Module["removeRunDependency"]("datafile_so_long.data");
      }
      Module["addRunDependency"]("datafile_so_long.data");
  ...
  loadPackage({
    "files": [ {
      "filename": "/assets/door.png",
      "start": 0,
      "end": 1298
    }, {
      "filename": "/assets/food.png",
      "start": 1298,
      "end": 3067
    }, {
